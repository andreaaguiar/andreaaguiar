<div align="center">
  ...
  <h3> Senior Security Engineer | GCP Professional Cloud Security Engineer | Certified Ethical Hacker (CEH) </h3>
...
### 🔎 [pysec-toolkit](https://github.com/andreaaguiar/pysec-toolkit)
A collection of seven security assessment tools written in Python: port and network scanning, subdomain and directory enumeration, hash cracking, SSH testing, and a web vulnerability scanner (XSS, SQLi, open redirect, security-header analysis). `Python` · `Scapy` · `Paramiko` · `BeautifulSoup`

### 🪪 [tracemark](https://github.com/andreaaguiar/tracemark)
A single-page browser tool that watermarks a document image (passport, ID) with a tamper-evident lattice, so a shared copy can be traced to one recipient and purpose. Runs fully in the browser, nothing is uploaded. `Watermark` · `Privacy` · `Identity`

### 🚩 [ctf-toolkit](https://github.com/andreaaguiar/ctf-toolkit)
A collection of CTF and penetration-testing cheatsheets spanning recon, privilege escalation, web attacks, cryptography, forensics, and reverse engineering, plus a tooling setup guide. `Cheatsheets` · `CTF` · `Pentesting`
...
![Renovate](https://img.shields.io/badge/Renovate-308BE3?logo=renovate&logoColor=fff)
